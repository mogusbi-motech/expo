import type { RncConfigCompatDependencyConfig, RncConfigCompatOptions, RncConfigCompatResult } from './rncConfigCompat.types';
...
export declare function resolveDependencyConfigAsync(platform: SupportedPlatform, name: string, packageRoot: string): Promise<RncConfigCompatDependencyConfig | null>;
